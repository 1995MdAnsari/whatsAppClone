...
class MainWhatsApp extends Component{
    ...
    state = {
        users : [
            ...
            // {img:"https://wallpapercave.com/wp/vHkAv20.jpg", names:"Rubel",msgArr:[], lastMsg:'Hi dooly'},

            // {img:"https://wallpaperaccess.com/full/148091.jpg", names:"Lakhan",msgArr:[], lastMsg:'hi amit'},
            // {img:"https://wallpaperaccess.com/full/148091.jpg", names:"Rocky",msgArr:[], lastMsg:'hello'},
            ...
            {   
                if(data.message!==''){
                    ...
                    if(num.names===findname){
                        ...
                        // else if((chatMsg[len-1]==='-' || chatMsg[len-1]==='+' || chatMsg[len-1]==='*' 
                        //     || chatMsg[len-1]==='/' || chatMsg[len-1]==='%'))  
                        // {
                        //     num.lastMsg=data.message;
                        //     let send = " I did not understand the problem";
